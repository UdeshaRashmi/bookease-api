...
export function AdminDateTime() {
  ...
  return (
    <div className="inline-flex h-10 w-full min-w-0 items-center justify-center gap-2 rounded-xl border border-cyan-100 bg-white px-3 text-sm font-medium text-slate-700 shadow-sm sm:w-auto sm:px-4">
